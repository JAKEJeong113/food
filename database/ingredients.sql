...
-- 3) 레시피
INSERT OR IGNORE INTO recipe (title, description, servings, cook_time_minutes, difficulty, kid_friendly, spicy_level) VALUES
('삼겹살 간장덮밥', '삼겹살을 간장 양념에 볶아 밥 위에 올리는 덮밥', 4, 18, '쉬움', 1, 0),
('두부계란전', '두부와 계란을 부쳐 만드는 간단한 전', 2, 12, '쉬움', 1, 0),
('김치찌개', '묵은지와 돼지고기로 끓이는 대표 가정식', 4, 25, '보통', 0, 2),
('애호박계란전', '애호박과 계란으로 만드는 아삭한 전', 2, 12, '쉬움', 1, 0),
('두부계란덮밥', '두부와 계란을 간장 소스에 올린 간단 덮밥', 2, 10, '쉬움', 1, 0),
('계란찜', '뚝배기 없이도 만드는 폭신한 계란찜', 2, 15, '쉬움', 1, 0),
('스팸김치볶음밥', '햄과 김치로 볶는 든든한 볶음밥', 2, 15, '쉬움', 1, 1),
('새우볶음밥', '냉동새우로 만드는 담백한 볶음밥', 2, 15, '쉬움', 1, 0),
('군만두', '냉동만두를 노릇하게 구운 간편식', 2, 10, '쉬움', 1, 0);
